...
void Reproduce20_002::executeEventFromParameter() {
                        ...
                        // if loose lepton is inside of fatjet
                            ...
                            if ( WRCand.M() > 800.0 )  {
                                ...
                                if (is_tmp_lead_el){ // ee 
                                        ...
                                        Boost_DYCREEleadfatjetpt = HNFatJet.Pt();
                                    ...
                                    if (is_tmp_lead_mu){// mumu
                                        ...
                                        Boost_DYCRMMleadfatjetpt = HNFatJet.Pt();
                                        ...
                                        if (WRMassGT800) {
                                            if(!IsDATA){
                                                ...
                                                if (is_tmp_lead_el) {
                                                    ...
                                                    Boost_SREEleadfatjetpt = HNFatJet.Pt();
                                                    ...
                                                    Boost_SRMMleadfatjetpt = HNFatJet.Pt();
    ...
    if(!IsDATA) {
        ...
        //resolved
            //DY CR
            if (is_Resolved_DY_EE) {
                FillHist(syst_name + "/Obj_PU_Corr_DYCR_Resolved_EE_pt", dilepton_pt, 1,100, 0., 1000.);
                FillHist(syst_name + "/Obj_PU_Corr_DYCR_Resolved_EE_leading_jet_pt", selected_jets[0].Pt(), 1, 200, 0., 2000.);
                FillHist(syst_name + "/Obj_PU_Corr_DYCR_Resolved_EE_subleading_jet_pt", selected_jets[1].Pt(), 1, 200, 0., 2000.);
                FillHist(syst_name + "/Obj_PU_Corr_DYCR_Resolved_EE_mlljj", WRCand.M(), 1, 800, 0., 8000.);
            }
            if (is_Resolved_DY_MM) {
                FillHist(syst_name + "/Obj_PU_Corr_DYCR_Resolved_MM_pt", dilepton_pt, 1,100, 0., 1000.);
                FillHist(syst_name + "/Obj_PU_Corr_DYCR_Resolved_MM_leading_jet_pt", selected_jets[0].Pt(),1, 200, 0., 2000.);
                FillHist(syst_name + "/Obj_PU_Corr_DYCR_Resolved_MM_subleading_jet_pt", selected_jets[1].Pt(), 1, 200, 0., 2000.);
                FillHist(syst_name + "/Obj_PU_Corr_DYCR_Resolved_MM_mlljj", WRCand.M(), 1, 800, 0., 8000.);
            }
            //SR
            if (is_Resolved_SR_EE) {
                FillHist(syst_name + "/Obj_PU_Corr_SR_Resolved_EE_ll_pt", dilepton_pt, 1, 8000, 0., 8000.);
                FillHist(syst_name + "/Obj_PU_Corr_SR_Resolved_EE_leading_jet_pt", selected_jets[0].Pt(), 1, 8000, 0., 8000.);
                FillHist(syst_name + "/Obj_PU_Corr_SR_Resolved_EE_subleading_jet_pt", selected_jets[1].Pt(), 1, 8000, 0., 8000.);
                FillHist(syst_name + "/Obj_PU_Corr_SR_Resolved_EE_mlljj", WRCand.M(), 1, 8000, 0., 8000.);
            }
            if (is_Resolved_SR_MM) {
                FillHist(syst_name + "/Obj_PU_Corr_SR_Resolved_MM_ll_pt", dilepton_pt, 1, 8000, 0., 8000.);
                FillHist(syst_name + "/Obj_PU_Corr_SR_Resolved_MM_leading_jet_pt", selected_jets[0].Pt(), 1, 8000, 0., 8000.);
                FillHist(syst_name + "/Obj_PU_Corr_SR_Resolved_MM_subleading_jet_pt", selected_jets[1].Pt(), 1, 8000, 0., 8000.);
                FillHist(syst_name + "/Obj_PU_Corr_SR_Resolved_MM_mlljj", WRCand.M(), 1, 8000, 0., 8000.);
            }//SS OS 필요 
            //Flav
            ...
            //DY CR
            if(is_Boosted_DY_EE) {
                FillHist(syst_name + "/Obj_PU_pt(ll)_boosted_DY_CR_EE", (*LeadLep + *LowMllLooseLepton).Pt(), 1, 1000, 0., 1000.);
                FillHist(syst_name + "/Obj_PU_leading_fatjet_pt_boosted_DY_CR_EE", HNFatJet.Pt(), 1, 2000, 0., 2000.);
                FillHist(syst_name + "/Obj_PU_m(lljj)_boosted_DY_CR_EE", WRCand.M(), 1, 8000, 0., 8000.);
            }
            if(is_Boosted_DY_MM) {
                FillHist(syst_name + "/Obj_PU_pt(ll)_boosted_DY_CR_MM", (*LeadLep + *LowMllLooseLepton).Pt(), 1, 1000, 0., 1000.);
                FillHist(syst_name + "/Obj_PU_leading_fatjet_pt_boosted_DY_CR_MM", HNFatJet.Pt(), 1, 2000, 0., 2000.);
                FillHist(syst_name + "/Obj_PU_m(lljj)_boosted_DY_CR_MM", WRCand.M(), 1, 8000, 0., 8000.);
            }

            //SR
            if(is_Boosted_SR_EE) {
                FillHist(syst_name + "/Obj_PU_boosted_Dilepton_Pt_ee", (*LeadLep + *SFLooseLepton).Pt(), 1, 8000, 0., 8000.);
                FillHist(syst_name + "/Obj_PU_leading_fatjet_pt_boosted_ee", HNFatJet.Pt(), 1, 8000, 0., 8000.);
                FillHist(syst_name + "/Obj_PU_boosted_WRMass_ee", WRCand.M(), 1, 8000, 0., 8000.);
            }
            if(is_Boosted_SR_MM) {
                FillHist(syst_name + "/Obj_PU_SR_boosted_Dilepton_Pt_mumu", (*LeadLep + *SFLooseLepton).Pt(), 1, 8000, 0., 8000.);
                FillHist(syst_name + "/Obj_PU_SR_leading_fatjet_pt_boosted_mumu", HNFatJet.Pt(), 1, 8000, 0., 8000.);
                FillHist(syst_name + "/Obj_PU_SR_boosted_WRMass_mumu", WRCand.M(), 1, 8000, 0., 8000.);
            }//SS OS 필요
            
            // Flav
            if(is_Boosted_Flav_EMJ) {
                FillHist(syst_name + "/Obj_PU_pt(ll)_boosted_e_mujet_Flavor_CR", (*LeadLep + *OFLooseLepton).Pt(), 1, 1000, 0., 1000.);
                FillHist(syst_name + "/Obj_PU_leading_fatjet_pt_boosted_e_mujet_Flavor_CR", HNFatJet.Pt(), 1, 2000, 0., 2000.);
                FillHist(syst_name + "/Obj_PU_m(lljj)_boosted_e_mujet_Flavor_CR", WRCand.M(), 1, 8000, 0., 8000.);
                FillHist(syst_name + "/Obj_PU_Boosted_Flavor_CR_e_mujet_Fatjet_SDMass", HNFatJet.SDMass() , 1, 10000, 0., 10000.);
            }
            if(is_Boosted_Flav_MEJ) {
                FillHist(syst_name + "/Obj_PU_pt(ll)_boosted_mu_ejets_Flavor_CR", (*LeadLep + *OFLooseLepton).Pt(), 1, 1000, 0., 1000.);
                FillHist(syst_name + "/Obj_PU_leading_fatjet_pt_boosted_mu_ejets_Flavor_CR", HNFatJet.Pt(), 1, 2000, 0., 2000.);
                FillHist(syst_name + "/Obj_PU_m(lljj)_boosted_mu_ejets_Flavor_CR", WRCand.M(), 1, 8000, 0., 8000.);
                FillHist(syst_name + "/Obj_PU_Boosted_Flavor_CR_mu_ejets_Fatjet_SDMass", HNFatJet.SDMass() , 1, 10000, 0., 10000.);
            }
            // syst_name: "Central", "PU_Weight_Up" 등
    }
}
