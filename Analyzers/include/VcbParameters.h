...
static inline std::unordered_map<std::string, float> Muon_Tight_Pt = {
    {"2016preVFP", 26.f}, {"2016postVFP", 26.f}, {"2017", 29.f},
    {"2018", 29.f},       {"2022", 26.f},        {"2022EE", 26.f},
    {"2022EE", 26.f},     {"2023", 26.f},        {"2023BPix", 26.f},
    {"2024", 26.f}};

static inline std::unordered_map<std::string, float> Electron_Tight_Pt = {
    {"2016preVFP", 35.f}, {"2016postVFP", 35.f}, {"2017", 37.f},
    {"2018", 37.f},       {"2022", 32.f},        {"2022EE", 32.f},
    {"2023", 32.f},       {"2023BPix", 32.f},    {"2024", 32.f}};
...
static inline std::unordered_map<std::string, JetTagging::JetFlavTagger>
    FlavTagger = {{"2016preVFP", JetTagging::JetFlavTagger::DeepJet},
...
static inline std::unordered_map<std::string, TString>
    FH_Control_Trigger_DoubleBTag = {{"2016preVFP", "HLT_PFHT400"},
...
static constexpr JetTagging::JetFlavTaggerWP FH_BTag_WP =
    JetTagging::JetFlavTaggerWP::Medium;

// SL part
static inline std::unordered_map<std::string, int> category_for_training_SL = {
    {"Vcb", 0}, {"TT+LF", 1}, {"TT+C", 2}, {"TT+B", 3}, {"Others", 4}};
static inline std::unordered_map<std::string, TString> Mu_Trigger = {
    {"2016preVFP", "HLT_IsoMu24"}, {"2016postVFP", "HLT_IsoMu24"},
    {"2017", "HLT_IsoMu27"},       {"2018", "HLT_IsoMu24"},
    {"2022", "HLT_IsoMu24"},       {"2022EE", "HLT_IsoMu24"},
    {"2023", "HLT_IsoMu24"},       {"2023BPix", "HLT_IsoMu24"},
    {"2024", "HLT_IsoMu24"}};
...
static inline std::unordered_map<std::string, TString> El_Trigger_SF_Key = {
    ...
    {"2024", "HLT_SF_Ele30_MVAiso80ID"}};

static inline std::unordered_map<std::string, TString> El_ID_SF_Key = {
    {"2016preVFP", "wp80iso"}, {"2016postVFP", "wp80iso"},
...
static inline std::unordered_map<std::string, std::string> Sample_Shorthand = {
    ...
    {"DYto2E_MLL120to200", "VJets"},
    {"DYto2E_MLL200to400", "VJets"},
    {"DYto2E_MLL400to800", "VJets"},
    {"DYto2E_MLL800to1500", "VJets"},
    {"DYto2E_MLL1500to2500", "VJets"},
    {"DYto2E_MLL2500to4000", "VJets"},
    {"DYto2E_MLL4000to6000", "VJets"},
    {"DYto2E_MLL6000toInf", "VJets"},
    {"DYto2Mu_MLL50to120", "VJets"},
    {"DYto2Mu_MLL120to200", "VJets"},
    {"DYto2Mu_MLL200to400", "VJets"},
    {"DYto2Mu_MLL400to800", "VJets"},
    {"DYto2Mu_MLL800to1500", "VJets"},
    {"DYto2Mu_MLL1500to2500", "VJets"},
    ...
    {"ST_tch_top", "ST"},
    {"ST_tch_antitop_had", "ST"},
    {"ST_tch_antitop_lep", "ST"},
    {"ST_tch_top_had", "ST"},
    {"ST_tch_top_lep", "ST"},
