...
DATA_FILES = [ "Muon"]
EXCLUDE_SAMPLES = ["DYJets_MG", "Skim", "EGamma","DYHT","WJetM","DYMLL","DYJetsTune"] 
...
def run_plot():
    ...
    latex.SetTextFont(42); latex.SetTextSize(0.030); latex.SetTextAlign(31); latex.DrawLatex(0.95, 0.93, "20..87 fb^{-1} (13 TeV)")
