...
def plot_signal_background_comparison(data_dir, hist_name, config, output_name="signal_background_comparison", systematic="Central", draw_tb_lines=True, target_tb_sample=None, normalize_by_bin_size=False):
