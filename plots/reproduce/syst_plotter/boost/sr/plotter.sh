...
python MM.py --xmin 800 --xmax 8000  --hist "Obj_PU_SR_boosted_WRMass_mm" --output "Boost_SR_MM_mlljj_2023" --xlabel "m(lJ)"  --rmin 0.7 --rmax 1.3 --ymin 3 --ymax 1e3 --bins "800,1000,1200,1500,1800,8000" 
