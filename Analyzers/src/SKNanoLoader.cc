...
void SKNanoLoader::SetMaxLeafSize(){
    ...
    FatJet_rawFactor.resize(kMaxFatJet);
    if(Run == 3){
...
void SKNanoLoader::Init() {
    ...
    SafeSetBranchAddress("Muon_tightCharge", Muon_tightCharge.data());
    ...
    SafeSetBranchAddress("Electron_tightCharge", Electron_tightCharge.data());
    ...
    SafeSetBranchAddress("FatJet_rawFactor", FatJet_rawFactor.data());
    if (Run == 3) {
