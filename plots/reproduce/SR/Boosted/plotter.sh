...
python plot_EE.py --x-range "800,8000" --rebin 10 --hist-name "SR_boosted_WRMass_ee_SS" --output "Boost_SR_EE_mlljj_SS_2023" --x-title "m(lJ)" --logy --y-range "0.7,1.3" --ymin 3 --ymax 1e4 --custom-bins "800,1000,1200,1500,1800,8000" --sr
...
python plot_EE.py --x-range "800,8000" --rebin 10 --hist-name "SR_boosted_WRMass_ee_OS" --output "Boost_SR_EE_mlljj_OS_2023" --x-title "m(lJ)" --logy --y-range "0.7,1.3" --ymin 3 --ymax 1e4 --custom-bins "800,1000,1200,1500,1800,8000" --sr
...
python plot_MM.py --x-range "800,8000" --rebin 10 --hist-name "SR_boosted_WRMass_mumu_SS" --output "Boost_SR_MM_mlljj_SS_2023" --x-title "m(lJ)" --logy --y-range "0.7,1.3" --ymin 3 --ymax 1e4 --custom-bins "800,1000,1200,1500,1800,8000" --sr 
...
python plot_MM.py --x-range "800,8000" --rebin 10 --hist-name "SR_boosted_WRMass_mumu_OS" --output "Boost_SR_MM_mlljj_OS_2023" --x-title "m(lJ)" --logy --y-range "0.7,1.3" --ymin 3 --ymax 1e4 --custom-bins "800,1000,1200,1500,1800,8000" --sr
