...
DATA_FILES = [ "Muon"]
EXCLUDE_SAMPLES = ["DYJets_MG", "Skim", "SingleElectron"] 
# electron trig 이상함 ..
...
def run_plot():
    ...
    latex.SetTextAlign(11); latex.SetTextFont(62); latex.SetTextSize(0.045); latex.DrawLatex(0.18, 0.82, HIST_NAME.split("_")[-1])
