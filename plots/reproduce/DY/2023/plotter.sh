...
python plot_EE.py --x-range "0,2000" --rebin 20 --hist-name "DYCR1_Resolved_leading_jet_pt" --output "DYCR1_EE_leading_pt_2022EE" --x-title "p_{T} of jet (GeV)" --logy --y-range "0.7,1.3" --ymax 1e4 --ymin 3
...
python plot_EE.py --x-range "0,500" --rebin 10 --hist-name "DYCR1_Resolved_subleading_jet_pt" --output "DYCR1_EE_subleading_pt_2022EE" --x-title "p_{T} of the subleading jet (GeV)" --logy --y-range "0.7,1.3" --ymax 1e4 --ymin 3
...
python plot_EE.py --x-range "0,2000" --rebin 20 --hist-name "DYCR2_Resolved_leading_jet_pt" --output "DYCR2_EE_leading_pt_2022EE" --x-title "p_{T} of jet (GeV)" --logy --y-range "0.7,1.3" --ymax 1e4 --ymin 3
...
python plot_EE.py --x-range "0,500" --rebin 10 --hist-name "DYCR2_Resolved_subleading_jet_pt" --output "DYCR2_EE_subleading_pt_2022EE" --x-title "p_{T} of the subleading jet (GeV)" --logy --y-range "0.7,1.3" --ymax 1e4 --ymin 3
