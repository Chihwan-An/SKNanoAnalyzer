...
## ee 
python plot_EE.py --x-range "0,1000" --rebin 10 --hist-name "pt(ll)_boosted_DY_CR_EE" --output "Boost_DYCR_EE_Dilepton_pt_2023" --x-title "p_{T}^{ll}(GeV)" --logy --y-range "0.7,1.3" --ymax 1e5 --ymin 0.3
...
## mumu 
python plot_MM.py --x-range "0,1000" --rebin 10 --hist-name "pt(ll)_boosted_DY_CR_MM" --output "Boost_DYCR_MM_Dilepton_pt_2023" --x-title "p_{T}^{ll}(GeV)" --logy --y-range "0.7,1.3" --ymax 1e5 --ymin 0.3
