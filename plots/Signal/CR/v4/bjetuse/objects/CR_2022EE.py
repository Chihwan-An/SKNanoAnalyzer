...
def load_histogram(file_path, hist_name, systematic="CR", silent=False):
...
def combine_Muon_Fata(data_dir, hist_name, systematic="CR"):
...
def load_signal_histograms(data_dir, hist_name, systematic="CR"):
...
def load_background_histograms(data_dir, hist_name, systematic="CR", draw_tb_lines=True):
...
def load_tb_sample_directly(data_dir, tb_sample_name, hist_name, systematic="CR"):
...
def plot_signal_background_comparison(data_dir, hist_name, config, output_name="signal_background_comparison", systematic="CR", draw_tb_lines=True, target_tb_sample=None, normalize_by_bin_size=False):
...
def parse_arguments():
    ...
    parser.add_argument("--output-name", type=str, default="Topjetnum_CR_2022EE",
                      help="Output file name prefix (default: Topjetnum_CR_2022EE)")
