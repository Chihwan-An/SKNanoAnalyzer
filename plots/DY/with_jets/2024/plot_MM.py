...
def combine_Muon_Fata(data_dir, hist_name, systematic="POGTIGHT"):
    ...
    for file_path in root_files:
        ...
        if (filename.startswith("Muon0_") or 
            filename.startswith("Muon1_") ):
...
def load_background_histograms(data_dir, hist_name, systematic="POGTIGHT", draw_tb_lines=True):
...
def load_tb_sample_directly(data_dir, tb_sample_name, hist_name, systematic="POGTIGHT"):
...
def plot_signal_background_comparison(data_dir, hist_name, config, output_name="signal_background_comparison", systematic="POGTIGHT", draw_tb_lines=True, target_tb_sample=None, normalize_by_bin_size=False, apply_scale_factors_flag=False, sf_file_path=None):
...
def parse_arguments():
    ...
    parser.add_argument("--output-name", type=str, default="Topjetnum_POGTIGHT_2022EE",
                      help="Output file name prefix (default: Topjetnum_POGTIGHT_2022EE)")
