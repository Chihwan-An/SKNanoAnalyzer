...
DATA_FILES = [ "EGamma"]
EXCLUDE_SAMPLES = ["DYJets_MG", "Skim", "Muon","DYHT","WJetM","DYMLL","DYJetsTune"] 
...
def run_plot():
    ...
    latex.SetTextFont(42); latex.SetTextSize(0.030); latex.SetTextAlign(31); latex.DrawLatex(0.95, 0.93, "9.68 fb^{-1} (13.6 TeV)")
