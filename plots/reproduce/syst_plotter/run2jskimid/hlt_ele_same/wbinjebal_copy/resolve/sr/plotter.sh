...
python EE.py --xmin 0 --xmax 1000  --hist "Obj_PU_Corr_SR_Resolved_EE_leading_lep_pt" --output "Resolve_SR_EE_LeadingLep_pt_2023" --xlabel 'p_{T}^{l1}(GeV)'  --rmin 0.7 --rmax 1.3  --ymax 1e3 --ymin 1e-3 --bins "0,50,100,150,200,250,300,350,400,450,500,550,600,650,700,750,800,850,900,950,1000"
python EE.py --xmin 0 --xmax 1000  --hist "Obj_PU_Corr_SR_Resolved_EE_subleading_lep_pt" --output "Resolve_SR_EE_SubleadingLep_pt_2023" --xlabel 'p_{T}^{l2}(GeV)'  --rmin 0.7 --rmax 1.3  --ymax 1e3 --ymin 1e-3 --bins "0,50,100,150,200,250,300,350,400,450,500,550,600,650,700,750,800,850,900,950,1000"
...
python MM.py --xmin 0 --xmax 1000  --hist "Obj_PU_Corr_SR_Resolved_MM_leading_lep_pt" --output "Resolve_SR_MM_LeadingLep_pt_2023" --xlabel 'p_{T}^{l1}(GeV)'  --rmin 0.7 --rmax 1.3  --ymax 1e3 --ymin 1e-3 --bins "0,50,100,150,200,250,300,350,400,450,500,550,600,650,700,750,800,850,900,950,1000"
python MM.py --xmin 0 --xmax 1000  --hist "Obj_PU_Corr_SR_Resolved_MM_subleading_lep_pt" --output "Resolve_SR_MM_SubleadingLep_pt_2023" --xlabel 'p_{T}^{l2}(GeV)'  --rmin 0.7 --rmax 1.3  --ymax 1e3 --ymin 1e-3 --bins "0,50,100,150,200,250,300,350,400,450,500,550,600,650,700,750,800,850,900,950,1000"
