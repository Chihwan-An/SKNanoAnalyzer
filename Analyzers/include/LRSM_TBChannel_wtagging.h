#ifndef LRSM_TBChannel_wtagging_h
#define LRSM_TBChannel_wtagging_h

#include "AnalyzerCore.h"
#include "SystematicHelper.h"

class LRSM_TBChannel_wtagging : public AnalyzerCore {
public:
    LRSM_TBChannel_wtagging();
    ~LRSM_TBChannel_wtagging();
    ...
    struct AnalysisCuts {
        ...
        float toptag_score = 0.957;
        float toptag_mass_low = 50;
        float toptag_mass_high = 110;
