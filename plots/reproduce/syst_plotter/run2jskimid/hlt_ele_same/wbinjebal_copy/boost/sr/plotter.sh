...
python EE.py --xmin 0 --xmax 1000 --hist "Obj_PU_boosted_LeadingLepPt_ee" --output "Boost_SR_EE_LeadingLep_pt_2023" --xlabel "Leading Lepton p_{T} (GeV)"  --rmin 0.7 --rmax 1.3 --ymax 1e3 --ymin 1e-3 --bins "0,50,100,150,200,250,300,350,400,450,500,550,600,650,700,750,800,850,900,950,1000"
python EE.py --xmin 0 --xmax 1000 --hist "Obj_PU_boosted_SubLeadingLepPt_ee" --output "Boost_SR_EE_SubLeadingLep_pt_2023" --xlabel "Subleading Lepton p_{T} (GeV)"  --rmin 0.7 --rmax 1.3 --ymax 5e2 --ymin 1e-3 --bins "0,50,100,150,200,250,300,350,400,450,500,550,600,650,700,750,800,850,900,950,1000"
## mumu sign inclusive
...
python MM.py --xmin 0 --xmax 1000 --hist "Obj_PU_boosted_LeadingLepPt_mumu" --output "Boost_SR_MM_LeadingLep_pt_2023" --xlabel "Leading Lepton p_{T} (GeV)"  --rmin 0.7 --rmax 1.3 --ymax 1e3 --ymin 1e-3 --bins "0,50,100,150,200,250,300,350,400,450,500,550,600,650,700,750,800,850,900,950,1000"
python MM.py --xmin 0 --xmax 1000 --hist "Obj_PU_boosted_SubLeadingLepPt_mumu" --output "Boost_SR_MM_SubLeadingLeap_pt_2023" --xlabel "Subleading Lepton p_{T} (GeV)"  --rmin 0.7 --rmax 1.3 --ymax 5e2 --ymin 1e-3 --bins "0,50,100,150,200,250,300,350,400,450,500,550,600,65