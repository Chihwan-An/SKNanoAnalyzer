...
python CR_2022EE.py --hist-name LeadingJetPt_CR --output-name LeadingJetpt_CR_2022_EE --x-range 30,200  --logy --ymax 1e1 --ymin 1e-2 --x-title "Jet p_{T} [GeV]" --custom-bins "30,40,50,70,90,120,150,5000"  #--normalize-by-bin-size --apply-scale-factors --sf-file SF.csv
...
python CR_2022EE.py --hist-name SubleadingMuonPt_CR --output-name SubleadingMuonpt_CR_2022_EE --x-range 30,150  --logy --ymax 1e1 --ymin 1e-3 --x-title "Subleading Muon p_{T} [GeV]" --custom-bins "30,40,50,60,70,80,90,100,125,5000"  #--normalize-by-bin-size --apply-scale-factors --sf-file SF.csv

python CR_2022EE.py --hist-name TopjetnumCR --output-name TopJetnum_CR_2022_EE --x-range 0,5  --logy --ymax 1e4 --ymin 1e-3 --x-title "Topjetnum"  #--normalize-by-bin-size
python CR_2022EE.py --hist-name JetnumCR --output-name Jetnum_CR_2022_EE --x-range 0,5  --logy --ymax 1e4 --ymin 1e-3 --x-title "Jetnum"
