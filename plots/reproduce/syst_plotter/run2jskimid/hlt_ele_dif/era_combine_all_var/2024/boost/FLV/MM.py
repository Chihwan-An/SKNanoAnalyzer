...
DEFAULT_DATA_PATH = "/gv0/Users/achihwan/SKNanoOutput/Reproduce20_002_copy/2024/"
...
DATA_FILES = [ "Muon"]
EXCLUDE_SAMPLES = ["DYJets_MG", "Skim", "EGamma", "DYHT","WJets"] 
SYST_LIST = ["Pileup", "ElectronID", "ElectronReco", "MuonID", "MuonReco", "MuonTrig", "MuonIso"]
...
def run_plot():
    ...
    # [수정] X_MIN_REQ, X_MAX_REQ를 안전하게 정의하여 NameError 방지
    ...
    latex.SetTextFont(42); latex.SetTextSize(0.030); latex.SetTextAlign(31); latex.DrawLatex(0.95, 0.93, "109.82 fb^{-1} (13 TeV)")
    latex.SetTextAlign(11); latex.SetTextFont(62); latex.SetTextSize(0.045); latex.DrawLatex(0.18, 0.82, "mu - e jet")
    latex.SetTextFont(42); latex.SetTextSize(0.040); latex.DrawLatex(0.18, 0.77, "Signal Region" if IS_BLIND else "Boost FLV CR")
    p1.RedrawAxis()
    ...
    if IS_BLIND:
        ...
        g_ratio_stat.SetFillColorAlpha(ROOT.kOrange, 0.6); g_ratio_stat.SetFillStyle(1001); g_ratio_stat.Draw("SAME E2")
